...
function Connect() {
  ...
  return (
    <>
      <div className="flex   w-screen min-h-screen justify-center    items-center   bg-gray-900">
        <div className="flex p-7    bg-white shadow-md hover:shodow-lg rounded-2xl">
          <div className="flex space-x-6   items-center justify-between">
            <div className="flex items-center space-x-3">
              <svg xmlns="http://www.w3.org/2000/svg" className=" w-36 " viewBox="0 0 212 189">
              ...
              <div className="flex ">
                <div className=" font-meduim leading-none text-2xl">Connect With Metamask</div>
              </div>
            </div>
            <button
              onClick={connectWallet}
              className=" bg-red-500 text-sm shadow-sm hover:shadow-lg font-medium p-3  border-2 border-red-500 text-white rounded-full"
            >
              Connect
            </button>
          </div>
