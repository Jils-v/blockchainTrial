...
import { fetchhospitaldata } from "../store/slices/AdminStore";
        ...
        <table className="w-full border-collapse bg-white text-left text-sm text-gray-500">
          ...
          {data &&
            data.Hospitals.map((item) => (
              <tbody key={item.id} className="divide-y divide-gray-100 border-t border-gray-100">
                <tr className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4">{Number(item.phone)}</td>
